...
[GitHub issue tracker](https://github.com/mosdef-hub/msibi/issues).
...
- The actual behavior
- The version of msibi you are using
...
- Create the `msibi-dev` conda environment using the `environment-dev.yml` file
- Make your changes
